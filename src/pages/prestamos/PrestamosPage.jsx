...
import {
  ...
  Grid, InputAdornment, InputLabel, MenuItem, Paper, Select, Stack, Table, TableBody, TableCell,
  ...
  return (
    <Stack spacing={2.5}>
      <Stack direction={{ xs: "column", md: "row" }} spacing={2} justifyContent="space-between" alignItems={{ md: "center" }}>
        <Box><Typography variant="h5">{detailOnly ? "Detalle Prestamos" : "Prestamos"}</Typography><Typography color="text.secondary">Control de prestamos y pagos</Typography></Box>
